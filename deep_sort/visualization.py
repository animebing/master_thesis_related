...
class Visualization(object):
    ...
    def __init__(self, seq_info, update_ms):
        ...
        # bingbing
        #self.viewer.enable_videowriter('./customer_videos/familymart_frames/familymart_yolo3.mp4', 'mp4v', fps=30)
    ...
    def draw_detections(self, detections):
        ...
        #for i, detection in enumerate(detections):
        #    vis_str = "%.2f" % (detection.confidence * 100)
        #    #print(detection.tlwh)
        #    #print(vis_str)
        #    self.viewer.rectangle(*detection.tlwh, label=vis_str)
