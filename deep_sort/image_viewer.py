...
class ImageViewer(object):
    ...
    * 'ESC' : quit
    ...
    def run(self, update_fun=None):
        ...
        idx = 1
        #tmp_dir = '/home/bingbing/git/MOT/deep_sort/customer_videos/familymart_frames/familymart_yolo3_frames'
        tmp_dir = '/home/bingbing/git/MOT/deep_sort/customer_videos/back_frames/back_yolo3_frames'
        ...
        while not self._terminate:
            ...
            if not is_paused:
                ...
                img_name = '{:05d}.jpg'.format(idx)
                cv2.imwrite(os.path.join(tmp_dir, img_name), cv2.resize(self.image, self._window_shape))
                idx += 1
