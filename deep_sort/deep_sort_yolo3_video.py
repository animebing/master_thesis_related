...
def gather_video_info(video_file):
    ...
    Dict
        ...
        * video_cap: cv2 video capture handle
...
def parse_args():
    ...
    parser.add_argument(
        "--video_file", help="Path to the video file",
...
if __name__ == "__main__":
    ...
    print(args)
    run(
        args.video_file, args.min_confidence,
        args.nms_max_overlap, args.min_detection_height,
        args.max_cosine_distance, args.nn_budget, args.display)

    """
    python deep_sort_yolo3_video.py \
    --video_file=./class.mp4 \
    --min_confidence=0.1 \
    --nn_budget=100 \
    --display
    """
