...
def main(args):
    ...
    output_name = video_name + '_processed_new' + video_ext
    ...
    while not terminate and cap.isOpened():
        ...
        if not is_paused:
            ...
            #time_1 = time.time()
            #print("processing time: %.5f" % (time_1 - time_0))
...
if __name__ == '__main__':
    ...
    """
    CUDA_VISIBLE_DEVICES=0 python2 tools/video_demo.py \
    ...
    --video_file video/color_crop.mp4 \
